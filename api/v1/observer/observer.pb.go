...
const DropReason_SUCCESS = flow.DropReason_SUCCESS
const DropReason_INVALID_PACKET = flow.DropReason_INVALID_PACKET
const DropReason_INTERFACE = flow.DropReason_INTERFACE
const DropReason_INTERFACE_DECRYPTED = flow.DropReason_INTERFACE_DECRYPTED
const DropReason_LB_SOCK_CGROUP_NO_BACKEND_SLOT_ENTRY_FOUND = flow.DropReason_LB_SOCK_CGROUP_NO_BACKEND_SLOT_ENTRY_FOUND
const DropReason_LB_SOCK_CGROUP_NO_BACKEND_ENTRY_FOUND = flow.DropReason_LB_SOCK_CGROUP_NO_BACKEND_ENTRY_FOUND
const DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_UPDATE_FAILED = flow.DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_UPDATE_FAILED
const DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_STALE = flow.DropReason_LB_SOCK_CGROUP_REVERSE_ENTRY_STALE
